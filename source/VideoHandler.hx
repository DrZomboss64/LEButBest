...
//I hate it when when is say 'Type not found : VideoHandler' even though i have one
...
class VideoHandler extends VLCBitmap
{
	...
	public function playVideo(Path:String, Loop:Bool = false, PauseMusic:Bool = false):Void
	{
		...
		// android can already do this, it can't use application's storage. // isDisplaying 121 & 124
